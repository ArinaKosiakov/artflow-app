...
export default function Header({
  ...
  const getTitle = () => {
    switch (activeTab) {
      case "projects":
        return t("header.artProjects");
      case "content":
        return t("header.contentCalendar");
      // case "ai":
      //   return t("header.aiAssistant");
      case "gallery":
        return t("header.ideasPrompts");
      default:
        return "";
    }
  };
  ...
  const getDescription = () => {
    switch (activeTab) {
      case "projects":
        return t("header.projectsDescription");
      case "content":
        return t("header.contentDescription");
      // case "ai":
      //   return t("header.aiDescription");
      case "gallery":
        return t("header.galleryDescription");
      default:
        return "";
    }
  };
  ...
  return (
    <>
      <div
        className={`h-28 ${darkMode ? "bg-gray-800 border-gray-700" : "bg-white border-gray-200"} border-b px-8 transition-colors flex items-center`}
      >
